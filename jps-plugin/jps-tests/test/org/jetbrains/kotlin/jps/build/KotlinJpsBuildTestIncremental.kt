...
import org.jetbrains.kotlin.daemon.common.COMPILE_DAEMON_CUSTOM_RUN_FILES_PATH
...
class KotlinJpsBuildTestIncremental : KotlinJpsBuildTest() {
    ...
    fun testJpsDaemonIC() {
        ...
        try {
            withSystemProperty(COMPILE_DAEMON_CUSTOM_RUN_FILES_PATH, daemonHome.absolutePath) {
